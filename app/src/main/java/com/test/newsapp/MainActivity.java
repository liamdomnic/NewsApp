...
public class MainActivity extends AppCompatActivity {
    ...
    String API_KEY="8190df9eb51445228e39734185311a66";
        ...
        protected void onPostExecute(String xml) {
            ...
            if(xml.length()>10){
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "Unexpected errror", Toast.LENGTH_SHORT).show();
                }
                ...
                Toast.makeText(getApplicationContext(), "No new found", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
